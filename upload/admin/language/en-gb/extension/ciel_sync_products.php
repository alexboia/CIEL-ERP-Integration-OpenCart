...
$_['ciel_err_sync_products_store_not_bound'] = 'Plugin configuration required! In order to sync product information, you need to first configure your plug-in settings.';

$_['ciel_sync_products_eligible_count_explanation'] = 'Eligible products are products that have been connected to their CIEL ERP counterparts';
...
$_['ciel_sync_products_connection_error_msg'] = 'Failed to update all product information due to a CIEL ERP Server communication issue.';